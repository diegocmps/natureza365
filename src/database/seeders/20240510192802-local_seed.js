    ...
    await queryInterface.bulkInsert("Locais", [
      {
        ...
        descricao:
          "Trilha de aproximadamente 45 min de subida, com uma vista para as praias do Santinho, Moçambique e Ingleses",
        cep: "88058-700",
      ...
      },
      {
        ...
        descricao:
          "Essas espetaculares formações rochosas de arenito botucatu são um verdadeiro tesouro nas encostas da Serra Geral. Com imponentes 90 metros de altura cada, essas rochas se destacam lado a lado, evocando a imagem de quatro soldados alinhados em guarda nas montanhas.",
        cep: "88450-000",
